...
**Tamp themes** is born from the intersection of architectural design, 70s retro-futurism, and the ritual of a perfect extraction. It moves away from the neon "gamer" aesthetic of modern editors toward a palette that feels grounded, material, and permanent.
...
#### Work in progress:
- **Vim** — includes Treesitter and LSP semantic groups
